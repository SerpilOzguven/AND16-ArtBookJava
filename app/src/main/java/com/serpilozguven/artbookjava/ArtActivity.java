package com.serpilozguven.artbookjava;
...
import com.serpilozguven.artbookjava.databinding.ActivityArtBinding;
...
public class ArtActivity extends AppCompatActivity {
    ...
    public void save(View view) {
        ...
        try {
            ...
            database.execSQL("CREATE TABLE IF NOT EXISTS arts(id INTEGER PRİMARY KEY, artname VARCHAR, paintername VARCHAR, year VARCHAR, image BLOB)");
